...
st.write(":streamlit: Hello Tejas, :streamlit: Arjun, :streamlit: Sarvesh ")
st.text("Lets Start")

name=st.text_input("Enter Name:")
if st.button("Greet"):
    st.success(f"Hello, :streamlit: {name}!")
...
st.image("https://preview.redd.it/qec3xy77utj61.png?width=1080&crop=smart&auto=webp&s=c31006b357c89ab9881363a745a3d757f600446a",caption="Straw Hats")
st.video("https://www.youtube.com/watch?v=u5apawfq-WM")
